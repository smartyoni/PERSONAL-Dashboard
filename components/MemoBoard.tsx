        ...
        return (
          <div key={originalIndex} className="flex-1 min-h-0 w-full">
            <button
              ...
              className={`w-full h-full px-2 py-1 rounded-lg border border-slate-200/60 text-[12px] font-bold transition-all active:scale-95 flex flex-col items-center justify-center hover:brightness-95 hover:shadow-sm overflow-hidden leading-tight ${
                hasMemo ? 'bg-purple-400 text-white' : 'bg-[#FBF3DB] text-slate-700'
              }`}
            >
