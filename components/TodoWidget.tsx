...
const TodoWidget: React.FC<TodoWidgetProps> = ({
    ...
    const SubSection = ({ title, type, items, memos, onShowMemo, sectionId }: {
        title: string,
        type: 1 | 2 | 3 | 4 | 5,
        items: ListItem[],
            ...
            <div 
                ...
                onDragOver={(e) => {
                    ...
                    if (e.dataTransfer.types.includes('todoSectionType')) {
                        ...
                        // Global cross-section drag over
    ...
    return (
        <div className="flex flex-col h-full bg-white border-2 border-black p-2 shadow-sm overflow-hidden rounded-2xl" data-section-id={dataSectionId}>
            ...
            <div className="flex-1 flex flex-col min-h-0 space-y-0 overflow-y-auto custom-scrollbar">
                ...
                <SubSection sectionId="todoCat4" title={info.category4Title} type={4} items={info.category4Items || []} memos={info.category4Memos} onShowMemo={onShowTodoCat4Memo} />
                <SubSection sectionId="todoCat5" title={info.category5Title} type={5} items={info.category5Items || []} memos={info.category5Memos} onShowMemo={onShowTodoCat5Memo} />
            </div>
